<?php
/**
 * @version $Header: /cvsroot/bitweaver/_bit_articles/BitArticle.php,v 1.73 2006/02/27 20:23:26 bitweaver Exp $
 * @package article
 *
 ...
 *
 * $Id: BitArticle.php,v 1.73 2006/02/27 20:23:26 bitweaver Exp $
 *
 ...
 * @version $Revision: 1.73 $ $Date: 2006/02/27 20:23:26 $ $Author: bitweaver $
 */
...
class BitArticle extends LibertyAttachable {
	...
	**/
	function getList( &$pParamHash ) {
		...
		$query = "SELECT a.article_id, a.description , a.author_name, a.image_attachment_id , a.publish_date , a.expire_date , a.rating , lc.*, atopic.topic_name, atopic.has_topic_image, atopic.active_topic, atype.*, astatus.`status_name`, lf.`storage_path` as `image_storage_path` $selectSql
			FROM `".BIT_DB_PREFIX."articles` a
				INNER JOIN      `".BIT_DB_PREFIX."liberty_content`     lc ON lc.`content_id`         = a.`content_id`

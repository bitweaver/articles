<?php 
// $Header: /cvsroot/bitweaver/_bit_articles/admin/admin_articles_inc.php,v 1.1 2005/06/30 01:10:46 bitweaver Exp $
...
$formArticleListing = array(
	...
	"art_list_img" => array(
		'label' => 'Article Image',
		'note' => 'Indicate whether an article uses an image or not.',
	),
);
...
if( $processForm ) {
	...
	simple_set_value( "article_description_length" );

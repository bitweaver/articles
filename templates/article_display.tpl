{* $Header: /cvsroot/bitweaver/_bit_articles/templates/article_display.tpl,v 1.13.2.13 2006/06/11 00:43:42 wolff_borg Exp $ *}
{strip}
...
<div class="{$outer_div|default:"post"}">
	<div class="floaticon">
		{if $gBitUser->hasPermission( 'bit_p_edit_article' ) || $gContent->isOwner( $article )}
